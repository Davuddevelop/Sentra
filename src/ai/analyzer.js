...
const SYSTEM_PROMPT = `You are Sentra's AI safety engine. You analyze children's AI chatbot behavioral signals and help parents understand what's happening — without making clinical or diagnostic statements.

You receive behavioral signal metadata (signal type, payload, context). Never request or reference actual message content.
...
const USER_PROMPT = (type, payload, context) => `Analyze this signal and return a JSON risk assessment.
